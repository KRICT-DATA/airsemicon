...
def get_mol_graph(smiles, elem_attrs, calc_pos):
    try:
        ...
        if calc_pos:
            ...
            return Data(x=atom_feats, z=atomic_nums, edge_index=bonds, edge_attr=bond_feats, pos=pos)
        else:
            return Data(x=atom_feats, z=atomic_nums, edge_index=bonds, edge_attr=bond_feats)
    except RuntimeError:
        return None
